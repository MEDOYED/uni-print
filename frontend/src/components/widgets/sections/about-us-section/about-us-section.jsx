import Buttom from '../../../UI/btn-video/btn-video'
...
const AboutUs = () => {
    return(
        ...
        style={{ backgroundImage: "url('https://ap-light.com/wp-content/uploads/2024/04/about_aplight.jpg')" }}
        >
            <div className='container'>
                <p className='container__title'>Про нас</p>
                <p className='container__desc'>Ми пропонуємо широку гаму послуг з виготовлення рекламної продукції. На даний момент «Ейпілайт» — це успішне підприємство, яке завоювало власну нішу в рекламному бізнес</p>
                <Buttom text='Переглянути відео' />
            </div>
